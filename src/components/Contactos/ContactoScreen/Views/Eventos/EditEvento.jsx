...
export const EditEvento = ({ evento, type, horario, contacto }) => {
                ...
                <form className='row flex justify-between' onSubmit={handleSubmit(handleSaveEdit)}>
                    ...
                    <div className='col-7 dark:bg-gray-900 ms-3 p-2 rounded-2xl'>
                        ...
                        <div className="items-center w-full p-3 space-y-4 text-gray-100 md:inline-flex md:space-y-0">
                            ...
                            <div className="max-w-sm mx-auto md:w-2/3">
                                <input
                                    type="text" defaultValue={evento.persona} disabled
                        ...
                        <div className="items-center w-full p-3 space-y-4 text-gray-100 md:inline-flex md:space-y-0">
                            <h2 className="max-w-sm mx-auto md:w-1/3 text-xl mt-1"> <FormattedMessage id="con.screen.actions.Ev.add.form.2" defaultMessage="Event Date" /> </h2>
                            <div className="max-w-sm mx-auto md:w-2/3">
                                <input
                                    type="date" defaultValue={evento.fecha}
                        ...
                        <>
                            {
                                ...
                                (
                                    <div className="items-center w-full p-3 space-y-4 text-gray-100 md:inline-flex md:space-y-0">
                                        ...
                                        <div className="max-w-sm mx-auto md:w-2/3">
                                            <input
                                                type="time" defaultValue={evento.hora}
                        ...
                        <div className="items-center w-full p-3 space-y-4 text-gray-100 md:inline-flex md:space-y-0">
                            <h2 className="max-w-sm mx-auto md:w-1/3 text-xl mt-1"> <FormattedMessage id="con.screen.actions.Ev.add.form.4" defaultMessage="Place" /> </h2>
                            <div className="max-w-sm mx-auto md:w-2/3">
                                <input
                                    type="text" defaultValue={evento.lugar}
                                    className="form-control form-control-lg rounded-lg text-center placeholder-gray-400"
                                    {...register("place")}
                                />
                            </div>
                    ...
                    <div className='col-4'>
                        ...
                        <div className='mt-2 flex justify-center'>
                            <button
                                className="p-3 rounded-lg bg-indigo-900 dark:bg-gray-900 dark:text-teal-300 hover:bg-teal-400 hover:text-gray-900 dark:hover:bg-green-900 dark:hover:text-gray-200"
                                type="submit"
                            >
                                <div className="ml-4 flex justify-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 me-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
