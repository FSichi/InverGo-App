...
export const TerminosyCondiciones = () => {
    ...
    localStorage.setItem("ruta", `/terms`);

    return (
        <div className='container mt-5 dark:text-gray-100'>
            ...
            <div className='ms-5 me-5 mt-4'>
                ...
                <p className='text-xl mt-2 text-gray-500 dark:text-gray-300'>By accessing this web site, you are agreeing to be bound by these web site Terms and Conditions of Use and agree that you are responsible for the agreement with any applicable local laws. If you disagree with any of these terms and conditions, you are prohibited from using or accessing this site. The materials contained in this web site are protected by applicable copyright and trade mark law. </p>
            </div>

            <div className='ms-5 me-5 mt-4'>

                <h2 className='text-2xl font-semibold mb-4'>2. Interpretation and Definitions  </h2>

                <h2 className='text-2xl font-semibold'>2.1 Interpretation</h2>

                <p className='text-xl mt-2 text-gray-500 dark:text-gray-300'>
                    The words of which the initial letter is capitalized have meanings defined
                    under the following conditions. The following definitions shall have the same
                    meaning regardless of whether they appear in singular or in plural.
                </p>

                <h2 className='text-2xl font-semibold mt-4'>2.2 Definitions </h2>

                <p className='text-xl mt-2 text-gray-500 dark:text-gray-300'> For the purposes of these Terms and Conditions: </p>

                <div className='ms-5 mt-3'>

                    <p className='text-xl mt-2 text-gray-500 dark:text-gray-300'>
                        <span className='text-2xl'>*</span>
                        Application means the software program provided by the Company downloaded by You on any electronic device, named InverGo
                    </p>
                    ...
                    <p className='text-xl mt-2 text-gray-500 dark:text-gray-300'>
                        <span className='text-2xl'>*</span>
                        Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to InverGo.
                    </p>
                    ...
                    <p className='text-xl mt-2 text-gray-500 dark:text-gray-300'>
                        ...
                        Template](https://www.privacypolicies.com/blog/sample-terms-conditions-
                        template/).
                    </p>
                    ...
                    <p className='text-xl mt-2 text-gray-500 dark:text-gray-300'>
                        <span className='text-2xl'>*</span>
                        Website refers to InverGo, accessible from [www.inver-go.com](www.inver-go.com)
                    </p>
            ...
            <div className='ms-5 me-5 mt-4'>
                <h2 className='text-2xl font-semibold'>3. Acknowledgment </h2>
            ...
            <div className='ms-5 me-5 mt-4'>
                <h2 className='text-2xl font-semibold'>4. Links to Other Websites</h2>
            ...
            <div className='ms-5 me-5 mt-4'>
                <h2 className='text-2xl font-semibold'>7. "AS IS" and "AS AVAILABLE" Disclaimer    </h2>
            ...
            <div className='ms-5 me-5 mt-4'>
                ...
                <p className='text-xl mt-2 text-gray-500 dark:text-gray-300'> If you have any questions about these Terms and Conditions, You can contact us: </p>

                <div className='ms-5 mt-3'>

                    <p className='text-xl mt-2 text-gray-500 dark:text-gray-300'>
                        <span className='text-2xl'>*</span>
                        By email: info.invergo@gmail.com
                    </p>
