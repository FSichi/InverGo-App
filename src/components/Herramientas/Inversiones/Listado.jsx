...
import { ViewInversion } from '../../Contactos/ContactoScreen/Views/Inversiones/ViewInversion';
import { useDispatch } from 'react-redux';
import { startDeleteInversion } from '../../../redux/actions/datosDB';
import Swal from 'sweetalert2';

export const Listado = ({ inversiones, name }) => {
    ...
    const handleVisualizar = (id) => {
        setInversion(getInversionByID(id, inversiones));
        setVisualizar(true);
    }
                        ...
                        <div className='row'>
                            ...
                            <div className='col-12'>
                                <div className="p-3 shadow-xl rounded-lg flex justify-between bg-blue-900 dark:bg-black">
                                    <button className='text-xl flex hover:text-orange-600 dark:hover:text-indigo-600' onClick={() => { setVisualizar(false) }}>
                                        <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 " fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12.066 11.2a1 1 0 000 1.6l5.334 4A1 1 0 0019 16V8a1 1 0 00-1.6-.8l-5.333 4zM4.066 11.2a1 1 0 000 1.6l5.334 4A1 1 0 0011 16V8a1 1 0 00-1.6-.8l-5.334 4z" />
                                        </svg>
                                        <span className='mt-1 ml-3'>
                                            <FormattedMessage id="con.screen.actions.Inv.screen.1" defaultMessage="Back to List" />
                                        </span>
                                    </button>
                                    <p className='text-2xl'> <FormattedMessage id="con.screen.actions.Inv.screen.title" defaultMessage="Details" /> </p>
                                    <button className='text-xl flex hover:text-red-400 dark:hover:text-red-600' onClick={handleDelete} >
                                ...
                                (inversiones.length === 0)
                                    ...
                                    (
                                        <h2 className='text-center text-gray-100 text-2xl p-4 rounded-lg'>
                                            <FormattedMessage id="con.screen.actions.Inv.0" defaultMessage="Info No Client" values={{ name: name }} />
                                        </h2>
                                    )
                                    :
                                    (
                                                        ...
                                                        <TableRow key={row.id}>
                                                            ...
                                                            <TableCell className=' text-center'>
                                                                <button
                                                                    ...
                                                                    style={{ fontFamily: 'Josefin Sans' }} onClick={() => { handleVisualizar(row._id) }}
                                                                >
