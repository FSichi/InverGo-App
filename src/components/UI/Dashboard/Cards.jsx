...
const CardIzquierda = ({ imgSrc, idMsg, defMsg, info }) => {
    ...
    return (
        <div className='col-lg-5 col-md-5 col-5 me-lg-5 ms-lg-0 me-md-5 ms-md-5 ms-2 me-3  text-white mt-3 bg-indigo-600 dark:bg-gray-800 rounded-xl shadow-2xl' >
...
const CardDerecha = ({ imgSrc, idMsg, defMsg, info }) => {
    ...
    return (
        <div className='col-lg-5 col-md-5 col-5 ms-4 ms-md-0 ms-lg-0 text-white mt-3 bg-indigo-600 dark:bg-gray-800 rounded-xl shadow-2xl' >
            <div className='row mt-3 mb-3'>
                <div className='col-lg-12 col-md-12 d-flex flex-column align-items-center'>
                    <img src={imgSrc} alt='Usuario' style={{ height: '70px', width: '70px' }} />
                </div>
